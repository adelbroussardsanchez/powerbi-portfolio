let
    ...
    #"Expanded IS_Other Expenses Accounts" = Table.ExpandTableColumn(#"Merged Queries1", "IS_Gross Profit Accounts", {"Level 1", "Level 2", "Level 2 Conditional", "Level 2 Order", "Level 4"}, {"Level 1", "Level 2", "Level 2 Conditional", "Level 2 Order", "Level 4"}),
    ...
    #"Grouped Rows1" = Table.Group(#"Renamed Columns4", {"Period", "Level 1", "Level 2", "Level 2 Conditional", "Level 2 Order", "Level 4", "Class"}, {{"Adjusted Value", each List.Sum([Adjusted Value]), type nullable number}})
in
    #"Grouped Rows1"