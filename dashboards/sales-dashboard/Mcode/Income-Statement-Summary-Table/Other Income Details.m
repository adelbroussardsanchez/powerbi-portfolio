let
    ...
    #"Expanded IS_Other Income Accounts" = Table.ExpandTableColumn(#"Merged Queries1", "IS_Gross Profit Accounts", {"Level 1", "Level 2", "Level 2 Conditional", "Level 2 Order", "Level 4"}, {"Level 1", "Level 2", "Level 2 Conditional", "Level 2 Order", "Level 4"}),
