let
    ...
    #"Added Custom3" = Table.AddColumn(#"Replaced Value27", "PK", each [#"Period - Copy"]&[Location]),
    ...
    #"Expanded TD_Gross Profit Details" = Table.ExpandTableColumn(#"Merged Queries2", "TD_Gross Profit Details", {"Period", "Location", "Adjusted Value"}, {"TD_Gross Profit Details.Period", "TD_Gross Profit Details.Location", "TD_Gross Profit Details.Adjusted Value"}),
    ...
    #"Added Conditional Column1" = Table.AddColumn(#"Added Conditional Column", "CustomLocation", each if [Location] = null then [TD_Gross Profit Details.Location] else [Location]),
    ...
    #"Removed Other Columns2" = Table.SelectColumns(#"Added Custom2",{"CustomPeriod", "CustomLocation", "Gross Profit %", "Level 1"}),
    #"Changed Type" = Table.TransformColumnTypes(#"Removed Other Columns2",{{"CustomPeriod", type date}, {"CustomLocation", type text}, {"Gross Profit %", type number}, {"Level 1", type text}}),
    #"Renamed Columns5" = Table.RenameColumns(#"Changed Type",{{"Gross Profit %", "Adjusted Value"}, {"CustomPeriod", "Period"}, {"CustomLocation", "Location"}}),
