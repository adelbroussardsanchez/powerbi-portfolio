let
    ...
    #"Grouped Rows1" = Table.Group(#"Renamed Columns4", {"Period", "Location"}, {{"Adjusted Value", each List.Sum([Adjusted Value]), type nullable number}}),
    ...
    #"Replaced Value27" = Table.ReplaceValue(#"Changed Type4",null,"",Replacer.ReplaceValue,{"Location"}),
    #"Added Custom2" = Table.AddColumn(#"Replaced Value27", "PK", each [#"Period - Copy"]&[Location]),
