let
    ...
    #"Expanded IS_COGS Accounts" = Table.ExpandTableColumn(#"Merged Queries1", "IS_Gross Profit Accounts", {"Level 1"}, {"Level 1"}),
    ...
    #"Grouped Rows1" = Table.Group(#"Renamed Columns4", {"Period", "Location"}, {{"COGS", each List.Sum([Adjusted Value]), type nullable number}})
in
    #"Grouped Rows1"