let
    ...
    #"Expanded BS_Assets Accounts" = Table.ExpandTableColumn(#"Merged Queries1", "BS_Assets Accounts", {"Level 1", "Level 1 Order", "Level 2 Conditional", "Level 2 Order", "Level 4 Conditional", "Level 4 Order"}, {"Level 1", "Level 1 Order", "Level 2 Conditional", "Level 2 Order", "Level 4 Conditional", "Level 4 Order"}),
